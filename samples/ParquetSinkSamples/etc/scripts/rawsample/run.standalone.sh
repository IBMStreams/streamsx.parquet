...
#Launching: /opt/ibm/InfoSphereStreams/4.0.1.0//java/bin/java -jar /homes/apyasic/github/streamsx.parquet/samples/ParquetSinkSamples/output/com.ibm.streamsx.parquet.sample.RawSample/Standalone/com.ibm.streamsx.parquet.sample.RawSample.sab -c -t 5 -l 2 com.ibm.streamsx.parquet.sample::RawSample.hdfsRootPath=/user/bigsql/ptest com.ibm.streamsx.parquet.sample::RawSample.hdfsUser=bigsql com.ibm.streamsx.parquet.sample::RawSample.hdfsUri=hdfs://108.168.234.156:8020
